...
class User ():
    ...
    def save(cls, data):
        ...
        return connectToMySQL ('users_crud_walkthrough').query_db(query,data)

    @classmethod
    def get_all_users(cls):
        query = 'SELECT * FROM users;'
        results = connectToMySQL('users_crud_walkthrough').query_db(query)
        users = []
    ...
    def get_one_user(cls,data):
        ...
        results = connectToMySQL('users_crud_walkthrough').query_db(query, data)
